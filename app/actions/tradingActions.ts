...
export async function getContracts(searchText: string = "NQ", live: boolean = false): Promise<ContractInfo[]> {
  try {
    console.log(`Fetching contracts for search: "${searchText}", live: ${live}`);
